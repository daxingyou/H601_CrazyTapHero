...
(function (ViewModel) {
    ...
    var MallItemVM = (function (_super) {
        ...
        function MallItemVM(_uiGroup, _onCallback) {
            ...
            _this.skinName = View.MallItem;
            _this.uiGroup = _uiGroup;
            _this.onCallback = _onCallback;
            _this.uiGroup.addChild(_this);
            return _this;
        }
        MallItemVM.prototype.createChildren = function () {
            _super.prototype.createChildren.call(this);
        };
        /**
         * @设置神器购买item数据.
         */
        MallItemVM.prototype.setMWBuyData = function () {
         ...
         */
        MallItemVM.prototype.createBuyPop = function () {
            if (this.onCallback) {
         ...
         * @按钮回调事件.
         */
        MallItemVM.prototype.onBuyMWEvent = function () {
            if (this.onCallback) {
                this.onCallback();
            }
        };
         ...
         * @设置神器item数据.
         */
        MallItemVM.prototype.setMWData = function (_data) {
            if (!_data || !_data.st) {
                alert("数据错误，请重新加载 ! ");
                return;
            }
         ...
         * @by cai_haotian 2016.2.1.
         */
        MallItemVM.prototype.createPop = function () {
            if (this.onCallback) {
         ...
         * @神器升级事件.
         */
        MallItemVM.prototype.onUpgradeMWEvent = function () {
            if (this.onCallback)
    ...
    __reflect(MallItemVM.prototype, "ViewModel.MallItemVM");
})(ViewModel || (ViewModel = {}));
//# sourceMappingURL=MallItemVM.js.map