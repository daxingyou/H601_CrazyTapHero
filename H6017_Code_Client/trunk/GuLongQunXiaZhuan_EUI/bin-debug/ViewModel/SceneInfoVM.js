...
(function (ViewModel) {
    ...
    var SceneInfoVM = (function (_super) {
         ...
         */
        SceneInfoVM.prototype.setOffLine = function () {
            var _this = this;
            if (Model.PlayerLocalService.PlayerData.offLineMoney) {
                this.offLineReward.setEffect();
                this.offLineReward.once(egret.TouchEvent.TOUCH_TAP, function () {
                    _this.offLineReward.visible = false;
                    var getView = new ViewModel.OffLineRewardVM(Main.singleton, function () { });
                }, this);
            }
            else {
                this.offLineReward.visible = false;
            }
        };
        /**
         * @boss按钮切换事件.
         ...
         */
        SceneInfoVM.prototype.initCBoss = function () {
            var _this = this;
            this.currentInfo.visible = false;
            this.cBossInfoGroup.visible = true;
            ...
            Main.singleton.mainGameVM.changeEnemy(Model.MonsterLocalService.MonsterList.length - 1);
            this.cBossBtn.once(egret.TouchEvent.TOUCH_TAP, this.cBossEvent, this);
            this.setCountDown(function () {
                _this.cBossBtn.removeEventListener(egret.TouchEvent.TOUCH_TAP, _this.cBossEvent, _this);
                _this.cBossEvent();
                Main.singleton.mainGameVM.challengeFinishTitle.visible = true;
                if (Model.WebValue.isTraditional) {
                    Main.singleton.mainGameVM.challengeFinishTitle.source = "icon_zhandoushibai_tw_png";
                }
                else {
                    Main.singleton.mainGameVM.challengeFinishTitle.source = "icon_zhandoushibai_png";
                }
                egret.setTimeout(function () {
                    Main.singleton.mainGameVM.challengeFinishTitle.visible = false;
                }, _this, 1000);
            }, 30);
        };
        /**
         ...
         * @by cai_haotian 2016.4.18.
         */
        SceneInfoVM.prototype.cBossEvent = function () {
            this.bossTimer.removeEventListener(egret.TimerEvent.TIMER, this.cTimeLeftEvent, this);
            this.bossTimer.removeEventListener(egret.TimerEvent.TIMER_COMPLETE, this.timeLeftComplete, this);
            this.bossTimer.stop();
            this.currentInfo.visible = true;
            this.cBossInfoGroup.visible = false;
            Model.PlayerLocalService.PlayerData.isChallenge = false;
            this.setMonsterHp();
        };
        /**
         * @设置挑战boss血量
        ...
        SceneInfoVM.prototype.setCountDown = function (_onTimeLeft, _time) {
            ...
            this.cCountTimeImage.width = 220;
            ...
            if (_time) {
                this.bossTimer.addEventListener(egret.TimerEvent.TIMER, this.cTimeLeftEvent, this);
                this.bossTimer.addEventListener(egret.TimerEvent.TIMER_COMPLETE, this.onCBossFinal, this);
         ...
         * @by cai_haotian 2016.4.18.
         */
        SceneInfoVM.prototype.cTimeLeftEvent = function () {
            this.currentLeftTime -= 0.1;
            this.cCountTimeLabel.text = this.currentLeftTime.toFixed(1);
            this.cCountTimeImage.width -= this.countTimePercent;
        };
        /**
         * @剩余时间.
         */
...
//# sourceMappingURL=SceneInfoVM.js.map