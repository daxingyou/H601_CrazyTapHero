module ViewModel {
    ...
    export class SceneInfoVM extends eui.Component {
        ...
        */
         ...
         * @离线奖励
         */
        public offLineReward: ViewModel.CloseBtnVM;
        /**
         * @礼包按钮
         */
        public giftBag: ViewModel.CloseBtnVM;
        /**
         * @当前关数
         */
         ...
         */ 
        public cBossInfoGroup:eui.Group;
        
        /**
         * @挑战boss按钮
         * @by cai_haotian 2016.4.18
         */ 
        private cBossBtn:eui.Image;
        
        /**
         * @挑战boss倒计时条
         * @by cai_haotian 2016.4.18
         */ 
        private cCountTimeImage:eui.ProgressBar;
        
        /**
         * @挑战boss倒计时剩余时间
         * @by cai_haotian 2016.4.18.
         */ 
        private cCountTimeLabel:eui.Label;
        
        /**
         * @挑战boss回调函数
         * @by cai_haotian 2016.4.18.
         */ 
        private onCBossFinal:Function;
...
//            console.log("zhujun bossBtn 默认状态: " + this.bossBtn.selected);//默认是false.
        ...
        private setOffLine(){
            if(Model.PlayerLocalService.PlayerData.offLineMoney){
                ...
                this.offLineReward.once(egret.TouchEvent.TOUCH_TAP,() => {
                    this.offLineReward.visible = false;
                    var getView = new ViewModel.OffLineRewardVM(Main.singleton,() => { });
                },this);
            }else{
                this.offLineReward.visible = false;
            }
...
//                Where(x=> x.monsterType != MonsterType[MonsterType.MONSTER_TYPE_BOSS]).ToArray();
            ...
            this.setCountDown(() => {
                this.cBossBtn.removeEventListener(egret.TouchEvent.TOUCH_TAP,this.cBossEvent,this);
                this.cBossEvent();
